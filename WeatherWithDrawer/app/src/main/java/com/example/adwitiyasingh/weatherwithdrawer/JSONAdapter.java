...
holder.Temp.setText("                 Temp : "+ (gettemp(thsitem.getMn().getTemp().intValue())));
        holder.tempMinMax.setText("Min : "+ (gettemp(thsitem.getMn().getTemp_min().intValue()))+"     Max : "+(gettemp(thsitem.getMn().getTemp_max().intValue())));
